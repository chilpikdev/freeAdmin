...
class ModeratorController extends Controller
{
    ...
    {
        $data = User::role('moderator')->get();

        return view("admin.pages.user.moderator.index")->with(["data" => $data]);
    }
    ...
    {
        return view("admin.pages.user.moderator.create");
    }
    ...
    public function store(UserFormRequest $request)
    {
        ...
        if ($request->has('images')) {
            foreach($request->images as $value) {
                ...
                $destinationPath = public_path().'/images/users/moderator' ;
                $value->move($destinationPath,$fileName);
                $images[] = 'images/users/moderator/'.$fileName;
            }
        }
    ...
    public function edit(string $id)
    {
        ...
        return view("admin.pages.user.moderator.create")->with(["data" => $data]);
    }
