...
@section('title', isset($data) ? "Edit Moderator" : "Add new Moderator")

@section('content_header')
<div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1>{{ isset($data) ? "Edit Moderator" : "Add new Moderator" }}</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route("admin.dashboard") }}">Dashboard</a></li>
            <li class="breadcrumb-item"><a href="{{ route("admin.moderators.index") }}">Moderators</a></li>
            <li class="breadcrumb-item active">{{ isset($data) ? "Edit Moderator " : "Add new Moderator" }}</li>
        </ol>
      </div>
    </div>
</div>
...
@section('content')
<div class="container-fluid">
    <form action="@if(isset($data)) {{ route('admin.moderators.update', $data->id) }} @else {{ route('admin.moderators.store') }} @endif" method="POST" enctype="multipart/form-data">
    @csrf
    @if (isset($data))
        @method("PUT")
    @endif
    <div class="row">
        ...
        <div class="card">
            ...
            <h3 class="card-title">Moderator data</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <div class="card-body">
